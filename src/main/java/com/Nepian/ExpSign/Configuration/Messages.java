...
public class Messages {
	...
	@PrecededBySpace
	public static String INVALID_SIGN_DETECTED = "経験値SHOPとして使用できません！";
	public static String YOU_CANNOT_CREATE_SIGN = "この種類の経験値SHOPを設置できません！";
	public static String SUCCESS_CREATE_SIGN = "経験値SHOPの看板を設置しました！";

...
public class ExpSignShopProtect implements Listener {
	...
	public static void onSignBreak(BlockBreakEvent event) {
		...
		Messages.sendPrefixMessage(player, Messages.PROTECT__SIGN_NOT_OWNER.get());
	}
	...
	public static void onBlockBreak(BlockBreakEvent event) {
		...
		event.setCancelled(true);
		Messages.sendPrefixMessage(event.getPlayer(), Messages.PROTECT__SIGN_ATTACHED_EXPSIGN.get());
	}
